...
export function wasm_bindgen__convert__closures__invoke0_mut__h7556e13387c007a1(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0017fbca495d30ef(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h23915d533ea01c5e(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h22a4bdc5dbe31031(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h6ecff56601a2c65d(a: number, b: number, c: number): void;
